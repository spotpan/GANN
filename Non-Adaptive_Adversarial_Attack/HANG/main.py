...
def main(args):
    ...
    _, val_acc_adv, test_acc_adv = test_defend(args,data)

    return val_acc_adv, test_acc_adv
...
if __name__ == '__main__':
    ...
    test_adv = []
    val_adv = []
    for j in trange(args.runtime):
        args.seed = seed_init + j
        val_acc_adv, test_acc_adv = main(args)
        val_adv.append(val_acc_adv)
        test_adv.append(test_acc_adv)
    
    print("Val adv: ", np.mean(val_adv), np.std(val_adv))
